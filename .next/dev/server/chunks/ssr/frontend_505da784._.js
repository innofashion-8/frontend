...
"[project]/frontend/src/app/dashboard/event/[key]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EventRegisterPage() {
    ...
    const { data: event, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'event',
            key
        ],
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$event$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["eventService"].getEvent(key),
        enabled: !!key
    });
    ...
    const { data: regStatus, isLoading: isStatusLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            try {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$event$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["eventService"].checkStatusRegistrations(key);
            } catch (error) {
                return null;
            }
        },
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsSubmitting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$event$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["eventService"].submitFinal(key, paymentFile);
    ...
    if (!event) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen flex items-center justify-center font-bold tracking-[0.3em] uppercase bg-[#0a0a0a]",
        style: {
            color: palette.ash
        },
...
//# sourceMappingURL=frontend_505da784._.js.map