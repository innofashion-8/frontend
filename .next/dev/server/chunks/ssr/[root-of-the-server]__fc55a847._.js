...
"[project]/src/services/division-service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const divisionService = {
    async getDivisions (page = 1) {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/divisions?page=${page}`, {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async getAllDivisions () {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/divisions?all=true', {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createDivision (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/divisions', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updateDivision (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/divisions/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
...
"[project]/src/components/admin/division/DivisionModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$division$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/division-service.ts [app-ssr] (ecmascript)");
...
function DivisionModal({ division, onClose }) {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])(division ? "UPDATING DIVISION..." : "CREATING DIVISION...");
            let response;
            if (division) {
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$division$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["divisionService"].updateDivision(division.id, formData);
            } else {
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$division$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["divisionService"].createDivision(formData);
            }
            if (response.success) {
...
"[project]/src/components/admin/division/DivisionClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$division$2f$DivisionModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/division/DivisionModal.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sweetalert2/dist/sweetalert2.esm.all.js [app-ssr] (ecmascript)");
"use client";
;
;
...
function DivisionClient({ data }) {
    ...
    const [editingDivision, setEditingDivision] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleDelete = async (division)=>{
        ...
        if (result.isConfirmed) {
            try {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])("DELETING DIVISION...");
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$division$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["divisionService"].deleteDivision(division.id);
                if (response.success) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSuccess"])({
                        title: "DELETED!",
    ...
    const columns = [
        ...
        },
        {
            header: "ACTIONS",
            key: "actions",
            render: (division)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex gap-2",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$division$2f$DivisionModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fc55a847._.js.map