...
const userService = {
    ...
    getUsers: async (page = 1, search = '', type = '')=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/users?${params.toString()}`, {
                method: 'GET',
                token: token
            });
            const response = await res.json();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const timer = setTimeout(()=>{
            if (phone || line || major || nrp || batch || institution) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userService"].saveDraft(draftForm).then(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11c3e1c5._.js.map