...
const adminService = {
    async getAdmins (page = 1) {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/admins?page=${page}`, {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createAdmin (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/admins', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updateAdmin (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/admins/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
...
"[project]/src/components/admin/admin-management/AdminModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/admin-service.ts [app-ssr] (ecmascript)");
...
function AdminModal({ admin, divisions, roles, onClose }) {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])(admin ? "UPDATING ADMIN..." : "CREATING ADMIN...");
            let response;
            if (admin) {
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminService"].updateAdmin(admin.id, formData);
            } else {
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminService"].createAdmin(formData);
            }
            if (response.success) {
...
"[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/admin-management/AdminModal.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sweetalert2/dist/sweetalert2.esm.all.js [app-ssr] (ecmascript)");
"use client";
;
;
...
function AdminManagementClient({ data, divisions, roles }) {
    ...
    const handleDelete = async (admin)=>{
        ...
        if (result.isConfirmed) {
            try {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])("DELETING ADMIN...");
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminService"].deleteAdmin(admin.id);
                if (response.success) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSuccess"])({
                        title: "DELETED!",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AdminModal"], {
                admin: editingAdmin,
                divisions: divisions,
                roles: roles,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8fb7efb2._.js.map