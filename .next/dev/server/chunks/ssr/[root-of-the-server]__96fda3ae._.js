...
"[project]/src/services/role-permission-service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const rolePermissionService = {
    ...
    async getRoles () {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/roles-permissions/roles', {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createRole (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/roles-permissions/roles', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updateRole (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/roles-permissions/roles/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
    ...
    async assignPermissions (roleId, permissions) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/roles-permissions/roles/${roleId}/permissions`, {
            method: 'POST',
            body: JSON.stringify({
                permissions
            })
    ...
    async getPermissions () {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/roles-permissions/permissions', {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createPermission (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/roles-permissions/permissions', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updatePermission (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/roles-permissions/permissions/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
...
"[project]/src/components/admin/role-permission/RoleModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/role-permission-service.ts [app-ssr] (ecmascript)");
...
function RoleModal({ role, onClose }) {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])(role ? "UPDATING ROLE..." : "CREATING ROLE...");
            if (role) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].updateRole(role.id, formData);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].createRole(formData);
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSuccess"])({
                title: role ? "UPDATED!" : "CREATED!",
                text: `Role has been ${role ? "updated" : "created"} successfully.`
            });
            onClose(true);
        } catch (error) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminError"])({
...
"[project]/src/components/admin/role-permission/PermissionModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PermissionModal({ permission, onClose }) {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])(permission ? "UPDATING PERMISSION..." : "CREATING PERMISSION...");
            if (permission) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].updatePermission(permission.id, formData);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].createPermission(formData);
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSuccess"])({
...
"[project]/src/components/admin/role-permission/RolePermissionClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/role-permission-service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/admin-swal.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$role$2d$permission$2f$RoleModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/role-permission/RoleModal.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$role$2d$permission$2f$PermissionModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/role-permission/PermissionModal.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sweetalert2/dist/sweetalert2.esm.all.js [app-ssr] (ecmascript)");
"use client";
;
;
...
function RolePermissionClient({ initialRoles, initialPermissions }) {
    ...
    const [isPermissionModalOpen, setIsPermissionModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [editingPermission, setEditingPermission] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchData = async ()=>{
        try {
            ...
            const [rolesResponse, permissionsResponse] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].getRoles(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].getPermissions()
            ]);
    ...
    const handleDeleteRole = async (role)=>{
        ...
        if (result.isConfirmed) {
            try {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])("DELETING ROLE...");
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].deleteRole(role.id);
                if (response.success) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSuccess"])({
                        title: "DELETED!",
    ...
    const handleDeletePermission = async (permission)=>{
        ...
        if (result.isConfirmed) {
            try {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])("DELETING PERMISSION...");
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].deletePermission(permission.id);
                if (response.success) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminSuccess"])({
                        title: "DELETED!",
    ...
    const handlePermissionToggle = async (permissionName)=>{
        ...
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$swal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminLoading"])("UPDATING PERMISSIONS...");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rolePermissionService"].assignPermissions(selectedRole.id, newPermissions);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: roles.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            isRoleModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$role$2d$permission$2f$RoleModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RoleModal"], {
                role: editingRole,
            ...
            isPermissionModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$role$2d$permission$2f$PermissionModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PermissionModal"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96fda3ae._.js.map