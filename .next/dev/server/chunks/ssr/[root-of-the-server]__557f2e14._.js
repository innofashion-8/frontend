...
"[project]/src/components/admin/competition-registration/RegistrationClient.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/components/admin/competition-registration/RegistrationClient.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/admin/competition-registration/RegistrationClient.tsx <module evaluation>", "default");
}),
"[project]/src/components/admin/competition-registration/RegistrationClient.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/components/admin/competition-registration/RegistrationClient.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/admin/competition-registration/RegistrationClient.tsx", "default");
}),
"[project]/src/components/admin/competition-registration/RegistrationClient.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$competition$2d$registration$2f$RegistrationClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/admin/competition-registration/RegistrationClient.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$competition$2d$registration$2f$RegistrationClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/components/admin/competition-registration/RegistrationClient.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$competition$2d$registration$2f$RegistrationClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/src/services/registration-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const registrationService = {
    exportCompetitionsRegistrations: async ()=>{
        try {
            const blob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/registrations/competitions/export', {
                method: 'GET',
                responseType: 'blob'
            });
    ...
    exportEventRegistrations: async ()=>{
        try {
            const blob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/registrations/events/export', {
                method: 'GET',
                responseType: 'blob'
            });
            const downloadUrl = window.URL.createObjectURL(blob);
    ...
    async getEventRegistrations (params = {}) {
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/registrations/events?${queryParams.toString()}`, {
            method: 'GET',
            token: token
        });
    ...
    async updateEventStatus (id, status, rejection_reason) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/registrations/events/${id}/status`, {
            method: 'PATCH',
            body: JSON.stringify({
                status,
                rejection_reason
    ...
    async getCompetitionsRegistrations (params = {}) {
        ...
        if (params.user_type && params.user_type !== 'ALL') queryParams.append('user_type', params.user_type);
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/registrations/competitions?${queryParams.toString()}`, {
            method: 'GET',
            token: token
        });
        const response = await res.json();
    ...
    async updateCompetitionStatus (id, status, rejection_reason) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/registrations/competitions/${id}/status`, {
            method: 'PATCH',
            body: JSON.stringify({
                status,
                rejection_reason
    ...
    async updateEventAttendance (id, attended) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/registrations/events/${id}/attendance`, {
            method: 'PATCH',
            body: JSON.stringify({
                attended
            })
...
"[project]/src/app/admin/(dashboard)/competition-registration/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$competition$2d$registration$2f$RegistrationClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/competition-registration/RegistrationClient.tsx [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$registration$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/registration-service.ts [app-rsc] (ecmascript)");
;
;
;
async function Page({ searchParams }) {
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$registration$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registrationService"].getCompetitionsRegistrations({
        page,
        search,
        status,
        competition_name,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$competition$2d$registration$2f$RegistrationClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
        data: response.data,
        meta: response,
        title: "Competition Registrations"
    }, void 0, false, {
        fileName: "[project]/src/app/admin/(dashboard)/competition-registration/page.tsx",
        lineNumber: 18,
        columnNumber: 5
    }, this);
}
}),
"[project]/src/app/admin/(dashboard)/competition-registration/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/admin/(dashboard)/competition-registration/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__557f2e14._.js.map