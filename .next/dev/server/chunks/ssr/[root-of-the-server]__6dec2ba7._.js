...
const authService = {
    ...
    impersonate: async (userId)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/impersonate', {
            method: 'POST',
            headers: {
...
"[project]/src/services/admin-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const adminService = {
    async getAdmins (page = 1) {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/admins?page=${page}`, {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createAdmin (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/admins', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updateAdmin (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/admins/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
...
"[project]/src/services/division-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const divisionService = {
    async getDivisions (page = 1) {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/divisions?page=${page}`, {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async getAllDivisions () {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/divisions?all=true', {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createDivision (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/divisions', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updateDivision (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/divisions/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
...
"[project]/src/services/role-permission-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const rolePermissionService = {
    ...
    async getRoles () {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/roles-permissions/roles', {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createRole (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/roles-permissions/roles', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updateRole (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/roles-permissions/roles/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
    ...
    async assignPermissions (roleId, permissions) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/roles-permissions/roles/${roleId}/permissions`, {
            method: 'POST',
            body: JSON.stringify({
                permissions
            })
    ...
    async getPermissions () {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/roles-permissions/permissions', {
            method: 'GET',
            token: token
        });
        if (!response.ok) {
    ...
    async createPermission (data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])('/api/admin/roles-permissions/permissions', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    async updatePermission (id, data) {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/admin/roles-permissions/permissions/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data)
        });
    },
...
"[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/components/admin/admin-management/AdminManagementClient.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/admin/admin-management/AdminManagementClient.tsx <module evaluation>", "default");
}),
"[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
}, "[project]/src/components/admin/admin-management/AdminManagementClient.tsx", "default");
}),
"[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminManagementClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminManagementClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminManagementClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/app/admin/(dashboard)/admin-management/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/admin-service.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$division$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/division-service.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/role-permission-service.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminManagementClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/admin-management/AdminManagementClient.tsx [app-rsc] (ecmascript)");
;
;
;
;
;
async function AdminManagementPage({ searchParams }) {
    const params = await searchParams;
    const page = parseInt(params.page || "1");
    const [admins, divisionsResponse, rolesResponse] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["adminService"].getAdmins(page),
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$division$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["divisionService"].getAllDivisions(),
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$role$2d$permission$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["rolePermissionService"].getRoles()
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$admin$2d$management$2f$AdminManagementClient$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
        data: admins,
        divisions: divisionsResponse.data || [],
        roles: rolesResponse.data || []
    }, void 0, false, {
        fileName: "[project]/src/app/admin/(dashboard)/admin-management/page.tsx",
        lineNumber: 17,
        columnNumber: 5
    }, this);
}
}),
"[project]/src/app/admin/(dashboard)/admin-management/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/admin/(dashboard)/admin-management/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__6dec2ba7._.js.map