...
"[project]/frontend/src/components/registration/CompleteProfileForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CompleteProfileForm() {
    ...
    const { data: session, status, update } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    const [line, setLine] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const handleFileUpload = async (e)=>{
        ...
        try {
            ...
            const compressedFile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$browser$2d$image$2d$compression$2f$dist$2f$browser$2d$image$2d$compression$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(file, options);
    ...
    const isInitialMount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(true); // Ref buat ngecek apakah ini render pertama kali
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const timer = setTimeout(()=>{
            ...
            if (phone || line || major || nrp || batch || institution) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userService"].saveDraft(draftForm).then(()=>console.log("Draft profile auto-saved")).catch(()=>console.error("Failed to auto-save profile draft"));
            }
    ...
    const handleSubmit = async (e)=>{
        ...
        setFormErrors(null);
        if (!documentFile) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire({
                icon: 'warning',
                title: 'FILE MISSING',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__24f1ddc7._.js.map