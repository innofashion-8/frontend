...
const registrationService = {
    async getEventRegistrations (page = 1) {
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/registrations/events?page=${page}`, {
            method: 'GET',
            token: token
        });
    ...
    async getCompetitionsRegistrations (page = 1) {
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/registrations/competitions?page=${page}`, {
            method: 'GET',
            token: token
        });
        const response = await res.json();
...
async function Page({ searchParams }) {
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$registration$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registrationService"].getCompetitionsRegistrations(page);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__91cf0532._.js.map