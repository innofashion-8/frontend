...
const authService = {
    ...
    getProfile: async ()=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/profile`, {
                method: 'GET'
            });
            return res.data;
        } catch (error) {
    ...
    updateProfile: async (formData)=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/profile/update`, {
                method: 'POST',
                body: formData
            });
    ...
    impersonate: async (userId)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["fetchBackend"])('/admin/impersonate', {
            method: 'POST',
            headers: {
