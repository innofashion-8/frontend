...
const userService = {
    ...
    getUsers: async (page = 1, search = '', type = '')=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBackend"])(`/admin/users?${params.toString()}`, {
                method: 'GET',
                token: token
            });
            const response = await res.json();
...
"[project]/src/components/registration/CompleteProfileForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CompleteProfileForm() {
    ...
    const { data: statusData, isLoading: isLoadingStatus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'profileStatus'
        ],
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].checkStatus,
    ...
    const [documentFile, setDocumentFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CompleteProfileForm.useEffect": ()=>{
                    ...
                    if (!isUpdatingRef.current) {
                        ...
                        update({
                            ...
                            "CompleteProfileForm.useEffect": ()=>{
                                ...
                                }["CompleteProfileForm.useEffect"], 300);
                            }
                        }["CompleteProfileForm.useEffect"]).catch({
                            "CompleteProfileForm.useEffect": ()=>{
            ...
            if (userType === 'INTERNAL') {
                ...
                setNrp({
                    "CompleteProfileForm.useEffect": (prev)=>prev || defaultNrp
                }["CompleteProfileForm.useEffect"]);
                setBatch({
                    "CompleteProfileForm.useEffect": (prev)=>prev || defaultBatch
                }["CompleteProfileForm.useEffect"]);
            } else {
            ...
            const timer = setTimeout({
                "CompleteProfileForm.useEffect.timer": ()=>{
                    if (phone || line || major || nrp || batch || institution) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].saveDraft(draftForm).then({
                            "CompleteProfileForm.useEffect.timer": ()=>{
                                console.log("Draft auto-saved");
                                setFormErrors(null);
                            }
                        }["CompleteProfileForm.useEffect.timer"]).catch({
                            "CompleteProfileForm.useEffect.timer": (error)=>{
                                console.error("Draft save failed:", error);
                                if (error.isValidationError) {
                                    const flatErrors = {};
                                    Object.keys(error.errors).forEach({
                                        "CompleteProfileForm.useEffect.timer": (key)=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].submitProfile(formData);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Complete your profile so you can register for Innofashion Show 8 events and competitions."
                }, void 0, false, {
                    fileName: "[project]/src/components/registration/CompleteProfileForm.tsx",
                    lineNumber: 327,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        userType === 'INTERNAL' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "grid grid-cols-1 md:grid-cols-2 gap-8",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DystopianInput, {
                                    label: "NRP",
                        ...
                        userType === 'EXTERNAL' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DystopianInput, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                formErrors?.ktm_path && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                formErrors?.id_card_path && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-red-500 text-[10px] mt-3 font-bold uppercase tracking-[0.2em]",
                                    children: [
                                        "⚠️ ",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: isCompressing ? 'COMPRESSING FILE...' : isLoading ? 'SYNCING DATA...' : 'SUBMIT & CONTINUE'
                        }, void 0, false, {
                            fileName: "[project]/src/components/registration/CompleteProfileForm.tsx",
                            lineNumber: 381,
                            columnNumber: 11
...
_s(CompleteProfileForm, "Kk3Vmnl8o0KsbsEXHS6CMEyoALs=", false, function() {
    return [
...
"[project]/src/components/ui/Beams.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MergedPlanes = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_s1(({ material, width, count, height }, ref)=>{
    _s1();
...
//# sourceMappingURL=src_b7076681._.js.map