...
function EvaluationResponsesClient({ eventId }) {
    ...
    const { data, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "EvaluationResponsesClient.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$evaluation$2d$question$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluationQuestionService"].getResponses(eventId)
        }["EvaluationResponsesClient.useQuery"]
    });
    if (isLoading) {
...
_s(EvaluationResponsesClient, "Z3b93vmhJEnCPN4ovcxRGbOtffM=", false, function() {
    return [
...
//# sourceMappingURL=_c2a78f4e._.js.map