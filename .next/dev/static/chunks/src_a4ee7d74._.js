...
const authService = {
    ...
    getProfile: async ()=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fetch$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchClient"])(`/api/auth/profile`, {
                method: 'GET'
            });
            return res.data;
        } catch (error) {
...
function CompleteProfileForm() {
    ...
    const isInitialMount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true); // Ref buat ngecek apakah ini render pertama kali
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CompleteProfileForm.useEffect": ()=>{
                ...
                "CompleteProfileForm.useEffect.timer": ()=>{
                    ...
                    if (phone || line || major || nrp || batch || institution) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userService"].saveDraft(draftForm).then({
                            "CompleteProfileForm.useEffect.timer": ()=>console.log("Draft profile auto-saved")
                        }["CompleteProfileForm.useEffect.timer"]).catch({
                            "CompleteProfileForm.useEffect.timer": ()=>console.error("Failed to auto-save profile draft")
                        }["CompleteProfileForm.useEffect.timer"]);
                    }
                }
            }["CompleteProfileForm.useEffect.timer"], 2000); // <-- 2000 ms (2 detik). Ubah jadi 3000 kalau mau 3 detik.
