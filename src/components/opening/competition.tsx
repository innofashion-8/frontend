...
const Competition = () => {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      const titleImages = gsap.utils.toArray(
        ".title-img",
        ...
        <div className="w-full flex flex-col items-center lg:items-end gap-5 md:gap-7 lg:gap-9 lg:mt-[-10%] perspective-[1200px]">
          {buttons.map((btn, idx) => (
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, rgba(85,85,85,0.7) 0%, rgba(30,30,30,0.9) 100%)",
                boxShadow:
                  "inset 0 2px 4px rgba(255,255,255,0.3), 0 10px 30px rgba(0,0,0,0.6)",
