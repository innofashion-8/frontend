...
export default function LoginClient() {
  ...
  return (
    <div 
      ...
      style={{ backgroundColor: themeColors.bg, backgroundImage: "url('/assets/BACKGROUND.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
    >
      <div className="w-full max-w-md p-10 md:p-12 rounded-[2.5rem] text-center relative z-10 backdrop-blur-md border border-white/10" style={{ backgroundColor: themeColors.cardBg }}>
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-black mb-2 tracking-widest uppercase" style={{ color: themeColors.textMain, textShadow: '0 0 20px rgba(255,255,255,0.6)', marginLeft: '-1.0rem' }}>
            INNOFASHION
          </h1>
