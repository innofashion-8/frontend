...
import LuxuryLoader from "@/components/InnoFashionLoader";
...
export default function HomeClient() {
  ...
  return (
    ...
    <main className="relative min-h-screen bg-[#0a0a0a] overflow-x-clip">
      <LuxuryLoader isLoading={isLoading} />
        ...
        <div className="relative w-full z-10">
          ...
          <div className="sticky top-0 h-screen w-full bg-[#0a0a0a] z-0 flex items-center justify-center">
            <IntroVideo isFinished={showContent} onVideoReady={() => setIsVideoLoaded(true)} />
          </div>
