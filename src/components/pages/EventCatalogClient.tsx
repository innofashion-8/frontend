      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <div className="mb-16">
          ...
          <p
            ...
            style={{ color: palette.ash }}
          >
            Join various exciting events, inspiring workshops, and spectacular
            exhibitions.
          </p>
        </div>
            ...
            {events.map((evt: any, idx: number) => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => {
                    if (!isOthersExpanded)
                      e.currentTarget.style.boxShadow = `0 20px 40px -15px ${palette.walnut}60`;
                  }}
                  onMouseLeave={(e) => {
                    if (!isOthersExpanded)
                ...
                >
                  ...
                  <div className="mb-8 grid grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        {isPaid
                          ? `Rp ${Number(evt.price).toLocaleString("id-ID")}`
                          : "NO CHARGE"}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="flex-grow flex flex-col justify-end">
                    {expandedId === evt.slug ? (
                      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 ease-[cubic-bezier(0.25,1,0.5,1)]">
                        ...
                        >
                          {evt.description ||
                            "Information classified. Join the event to decrypt the full experience."}
                        </p>
