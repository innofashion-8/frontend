  ...
  return (
    <>
      ...
      <div
        ...
        ${isActive ? "left-[230px] bg-transparent shadow-none" : "bg-[#e2e2de]/80 backdrop-blur-md"}`}
      >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide">
          <ul className="flex flex-col gap-1 w-full p-0 m-0">
            {adminMenus.map((item, index) => {
              // Cek apakah url saat ini cocok dengan menu
              ...
              return (
                <li key={index} className="w-full h-[50px] leading-[50px]">
                  ...
                  >
                    ...
                    <span className={`font-semibold font-body text-[15px] transition-opacity duration-300 ${isActive ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
                      {item.name}
                    </span>
                  </Link>
                </li>
        ...
        <div className="mt-auto pb-4 w-full">
          ...
          <button 
            ...
            className="flex items-center w-full h-[50px] rounded-xl text-[#d9534f] hover:bg-[#d9534f]/10 transition-all duration-400 relative"
          >
